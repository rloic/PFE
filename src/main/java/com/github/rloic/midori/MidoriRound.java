...
public class MidoriRound {
    ...
    public MidoriRound(
        ...
        for (int i=0; i<r-1; i++){
            ΔY[i][0][0] = ΔX[i][0][0];	ΔY[i][1][0] = ΔX[i][2][2];	ΔY[i][2][0] = ΔX[i][1][1];	ΔY[i][3][0] = ΔX[i][3][3];
            ΔY[i][0][1] = ΔX[i][2][3];	ΔY[i][1][1] = ΔX[i][0][1];	ΔY[i][2][1] = ΔX[i][3][2];	ΔY[i][3][1] = ΔX[i][1][0];
            ΔY[i][0][2] = ΔX[i][1][2];	ΔY[i][1][2] = ΔX[i][3][0];	ΔY[i][2][2] = ΔX[i][0][3];	ΔY[i][3][2] = ΔX[i][2][1];
            ΔY[i][0][3] = ΔX[i][3][1];	ΔY[i][1][3] = ΔX[i][1][3];	ΔY[i][2][3] = ΔX[i][2][0];	ΔY[i][3][3] = ΔX[i][0][2];
            for(int k=0; k<4; k++){
                for (int j=0; j<4; j++){
